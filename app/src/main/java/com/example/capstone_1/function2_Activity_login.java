...
import com.example.capstone_1.databinding.ActivityMainFunction2LoginBinding;
import com.google.android.material.navigation.NavigationView;

import java.util.HashMap;

public class function2_Activity_login extends AppCompatActivity {

    private ActivityMainFunction2LoginBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMainFunction2LoginBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        setSupportActionBar(binding.appBarFunction2Login.toolbarFunction2Login);
        DrawerLayout drawer = binding.function2DrawerLayoutLogin;
        NavigationView navigationView = binding.navFunction2ViewLogin;
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_function2_login);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId())
                {
                    case R.id.nav_main_login:
                        Intent intent_main = new Intent(function2_Activity_login.this, MainActivity_login.class);
                    ...
                    case R.id.nav_function1_login:
                        Intent intent_function1 = new Intent(function2_Activity_login.this, function1_Activity_login.class);
                    ...
                    case R.id.nav_function3_login:
                        Intent intent_function3 = new Intent(function2_Activity_login.this, function3_Activity_login.class);
                    ...
                    case R.id.nav_function4_login:
                        Intent intent_function4 = new Intent(function2_Activity_login.this, function4_Activity_login.class);
                ...
                DrawerLayout drawer = findViewById(R.id.function2_drawer_layout_login);
